                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          decoration: InputDecoration(
                              labelText: "Email",
                              hintText: "e.g. iamngoni@product.locator",
                              border: OutlineInputBorder(
                                  gapPadding: 3.5
                              )
                          ),
                      ...
                      MaterialButton(
                        ...
                        onPressed: () async {
                          if(_formKey.currentState.validate()){
                            ...
                            pr.show();
                            var user = await _register(pr, this.username, this.email, this.mobileNumber, this.password);
                            if(user.username != null){
                              pr.update(
                                  message: "Account created. User can now log in.",
